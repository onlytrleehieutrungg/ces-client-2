...
import EmployeeTransactionTableRow from './EmployeeTransactionTableRow'
import EmployeeTransactionTableToolbar from './EmployeeTransactionTableToolbar'
...
export default function EmployeeTransactionTable({ employeeId }: Props) {
  const {
    dense,
    page,
    order,
  ...
  const STATUS_OPTIONS = ['order', 'benefit']
  ...
  const { currentTab: filterStatus, onChangeTab: onChangeFilterStatus } = useTabs('order')
  ...
  return (
    <Card>
      ...
      <EmployeeTransactionTableToolbar
